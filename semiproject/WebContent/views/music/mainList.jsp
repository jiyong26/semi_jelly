	...
	<nav id="fix_side">
		...
		<div id="fix_side_menu">
			<div>
				...
				<div class="fix_each">
                            <img src="${pageContext.request.contextPath}/image/006-star.svg" class="fix_menu_icon"> <label for="membership" class="fix_each_menu" onclick="location.href='MembershipServlet';">이용권구매</label>
				</div>
			</div>
		</div>
		<div class="fix_btn">
